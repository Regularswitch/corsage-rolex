<section class="rlx_slider">
    <div class="container-fluid container-slider-rlx">
        <div class="row">
            <div class="offset-lg-2 col-lg-8 offset-md-1 col-md-10 col-sm-12 col-12">
                <span><strong style="margin-bottom: 20px; display: block; color: black; padding-left: 14px">Descubra muito mais</strong></span>
                <div class="swiper-container-rlx_mini">
                    ...
                    <div class="swiper-pagination-rlx_mini"></div>
                    <div class="swiper-button-prev-rlx_mini"></div>
                    <div class="swiper-button-next-rlx_mini"></div>
                </div>
            </div>
        </div>
    </div>
